...
// Define a constant (tasks.json)
define("TASKS_FILE", "tasks.json");

// Create a function to load tasks from the tasks.json 
...
// Load tasks from the tasks.json
$tasks = loadTasks();

// Create a function to save tasks to tasks.json
// This function will take an array of tasks and save it back to the JSON file
...
if($_SERVER['REQUEST_METHOD'] === 'POST') {
    // Handle task addition (check if task is provided, then add it to the tasks array and save)
